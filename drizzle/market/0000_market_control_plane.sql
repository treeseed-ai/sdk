...
CREATE TABLE "project_contribution_attestation_receipts" (
	"id" text PRIMARY KEY NOT NULL,
...
CREATE TABLE "project_contribution_authorizations" (
	"id" text PRIMARY KEY NOT NULL,
	"project_id" text NOT NULL,
	"generation" integer NOT NULL,
	"status" text NOT NULL,
...
CREATE UNIQUE INDEX "idx_project_contribution_attestation_receipts_assignment_head" ON "project_contribution_attestation_receipts" USING btree ("assignment_id","head_sha","authorization_generation");
CREATE INDEX "idx_project_contribution_attestation_receipts_project" ON "project_contribution_attestation_receipts" USING btree ("project_id","status");
CREATE UNIQUE INDEX "idx_project_contribution_authorizations_generation" ON "project_contribution_authorizations" USING btree ("project_id","generation");
CREATE INDEX "idx_project_contribution_authorizations_status" ON "project_contribution_authorizations" USING btree ("project_id","status");
