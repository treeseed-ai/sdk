...
} from '../../../../src/operations/services/repositories/github-automation.ts';
...
describe('github automation workflow generation', () => {
	it('renders the web deploy workflow with the tenant action entrypoint', () => {
		...
		expect(web).toContain('TREESEED_API_WEB_SERVICE_SECRET: ${{ secrets.TREESEED_WEB_SERVICE_SECRET || secrets.TREESEED_API_WEB_SERVICE_SECRET }}');
