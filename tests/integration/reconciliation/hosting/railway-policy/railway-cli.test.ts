...
vi.mock('../../../../../src/entrypoints/runtime/managed-dependencies.ts', () => ({
	resolveToolCommand: vi.fn(() => ({ command: 'railway', argsPrefix: [] })),
}));
vi.mock('../../../../../src/configuration/service-credentials.ts', () => ({
	withServiceCredentialEnv: vi.fn((env) => env),
}));

import { runRailwayCliJson } from '../../../../../src/operations/services/hosting/railway/railway-cli.ts';
