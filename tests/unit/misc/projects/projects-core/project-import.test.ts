...
import { githubRepositoryCredentialEnvName } from '../../../../../src/operations/services/configuration/github-credentials.ts';
...
describe('project repository import planning', () => {
	...
	it('detects common site and content path candidates', () => {
		...
		const rootPlan = planRepositoryImport({
			team: 'treeseed',
	...
	it('emits diagnostics for ambiguous or missing paths without forcing restructuring', () => {
		const ambiguous = planRepositoryImport({
			team: 'treeseed',
