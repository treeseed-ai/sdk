...
import type { WorkflowResult } from '../../../../../src/operations/workflow.ts';
import { WorkflowError } from '../../../../../src/workflow/operations.ts';
import {
...
describe('workspace-save script compatibility helpers', () => {
	...
	it('preserves workflow error codes and exit codes for compatibility', () => {
		const error = new WorkflowError('save', 'merge_conflict', 'conflicts detected', {
