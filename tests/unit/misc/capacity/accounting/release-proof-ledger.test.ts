...
import { computeProofInputHash, createProofRecord, type ProofInput } from '../../../../../src/operations/services/guarantees/release-proof.ts';
import { findReusableProof, invalidateProofs, readProofLedger, writeProofRecord } from '../../../../../src/operations/services/capacity/accounting/release-proof-ledger.ts';
...
function proofInput(overrides: Partial<ProofInput> = {}): ProofInput {
	return {
		subject: {
			kind: 'package',
