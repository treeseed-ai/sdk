...
import {
	...
	listAgentToolIds,
} from '../../../../src/agents/agent-tools.ts';
import { AGENT_OPERATION_NAMES } from '../../../../src/operations/agents/agent-tools.ts';
...
describe('agent tool registry', () => {
	...
	it('exposes generic and generated model-aware content tools', () => {
		...
		expect(AGENT_TOOL_DEFINITIONS.find((definition) => definition.id === 'treeseed.questions.create')).toMatchObject({
