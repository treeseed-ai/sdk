...
import { createLocalSeedBootstrapAdapter } from '../../src/reconcile/local-seed-bootstrap-adapter.ts';
import type { TreeseedDesiredUnit, TreeseedReconcileAdapterInput } from '../../src/reconcile/contracts.ts';

function adapterInput(root: string, modulePath: string): TreeseedReconcileAdapterInput {
