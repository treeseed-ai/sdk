...
describe('TreeDB search index client', () => {
	it('calls refresh, status, and compact endpoints and unwraps payloads', async () => {
		...
		expect(calls.map((call) => call.url)).toEqual([
			'https://treedb.example.test/api/v1/repos/repo_1/search/index/refresh',
			'https://treedb.example.test/api/v1/repos/repo_1/search/index/status?ref=refs%2Fheads%2Fmain',
			'https://treedb.example.test/api/v1/repos/repo_1/search/index/compact',
		]);
