...
describe('team project portfolio demo scene', () => {
	it('validates and plans the tracked scenario scene', () => {
		...
		const report = validateTreeseedScene({ projectRoot, scene: 'team-project-portfolio-demo' });
	...
	it('keeps the generated scene placeholder replacement narrow and documented', () => {
		...
		const generatorPath = resolve(projectRoot, 'scenes/team-project-portfolio-demo.generate.mjs');
