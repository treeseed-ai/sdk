...
describe('TreeDbClient git remote and storage helpers', () => {
	it('pushes, fetches, checks mirror health, promotes mirror, compacts, and backs up storage', async () => {
		...
		expect(calls.map((call) => call.url)).toEqual([
			'https://treedb.example.test/api/v1/repos/repo_1/push',
			'https://treedb.example.test/api/v1/repos/repo_1/sync',
			'https://treedb.example.test/api/v1/repos/repo_1/mirrors/mirror_1/health',
			'https://treedb.example.test/api/v1/repos/repo_1/mirrors/mirror_1/promote',
			'https://treedb.example.test/api/v1/admin/storage/compact',
			'https://treedb.example.test/api/v1/admin/storage/backup',
		]);
