...
import { prepareCloudflareLocalRuntime, spawnProcess, startWranglerDev } from '../../src/operations/services/runtime/local-dev.ts';
import { fixtureRoot, fixtureWranglerConfig } from '../../src/operations/services/runtime/runtime-paths.ts';
...
async function main() {
	prepareCloudflareLocalRuntime({
		...
		envOverrides: {
			...
			FORMS_LOCAL_BYPASS_CLOUDFLARE_GUARDS: 'false',
			SMTP_HOST: '127.0.0.1',
			SMTP_PORT: '1025',
		},
	});
