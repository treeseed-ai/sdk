...
if (process.env.GITHUB_REF_NAME && process.env.GITHUB_REF_NAME !== evidence.packages[0]?.version) throw new Error('Release tag does not identify the sealed package version.');
