...
import { publishableWorkspacePackages, changedWorkspacePackages, run } from '../../../src/operations/services/treedx/workspaces/workspace-tools.ts';
...
run(process.execPath, [packageScriptPath('treedx/workspaces/workspace-release-verify'), '--changed', '--full-smoke']);
