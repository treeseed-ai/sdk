...
import { WorkflowError, WorkflowSdk, type WorkflowResult } from '../../../src/operations/workflow.ts';
import {
	formatWorkspaceSaveFailureReport,
	formatWorkspaceSaveSuccessReport,
	parseWorkspaceSaveScriptArgs,
} from '../../../src/operations/services/treedx/workspaces/workspace-save-script.ts';
...
async function main() {
	...
	try {
		...
		writeSaveReport(formatWorkspaceSaveSuccessReport(result as WorkflowResult<Record<string, unknown>>));
