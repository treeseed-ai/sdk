...
import { listTemplateProducts, resolveTemplateProduct, serializeTemplateRegistryEntry, validateTemplateProduct } from '../../src/operations/services/support/template-registry.ts';
