...
import { listTemplateProducts, resolveTemplateProduct, serializeTemplateRegistryEntry, validateTemplateProduct } from '../src/operations/services/template-registry.ts';
