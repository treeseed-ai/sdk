...
import { corePackageRoot, packageScriptPath, spawnNodeBinary, resolveWranglerBin } from '../../src/operations/services/agents/runtime-tools.ts';
import { applyEnvironmentToProcess, assertCommandEnvironment } from '../../src/operations/services/configuration/config-runtime.ts';
import { ensureGeneratedWranglerConfig } from '../../src/operations/services/hosting/deployment/deploy.ts';
import {
	...
	writeDevReloadStamp,
	workspaceSdkRoot,
} from '../../src/operations/services/runtime/watch-dev.ts';
...
function runTenantBuildCycle({ includePackageBuild = false, includeSdkBuild = false, fatal = true } = {}) {
	...
	const buildScripts = [
		['content/patch-starlight-content-path', []],
		['aggregate-book', []],
	...
	const built = runNodeScript(packageScriptPath('build/tenant-build'), [], {
		fatal,
