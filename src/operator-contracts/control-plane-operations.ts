...
export const CONTROL_PLANE_OPERATIONS = {
	...
	planning: {
		...
		acceptExecutionInput: resource('planning.execution.inputs.accept', 'POST', '/v1/decision-execution-inputs/{inputId}/accept', { inputId: z.string().min(1) }, { capability: 'planning.decide', scopes: ['treeseed:execution'], surfaces: ['rest', 'mcp_tool'], concurrency: true }),
		requestExecutionInputRevision: resource('planning.execution.inputs.revision.request', 'POST', '/v1/decision-execution-inputs/{inputId}/request-revision', { inputId: z.string().min(1) }, { capability: 'planning.decide', scopes: ['treeseed:execution'], surfaces: ['rest', 'mcp_tool'], concurrency: true }),
	},
	estimates: {
		...
		accept: resource('estimates.accept', 'POST', '/v1/structured-agent-estimates/{estimateId}/accept', { estimateId: z.string().min(1) }, { capability: 'estimates.decide', scopes: ['treeseed:execution'], surfaces: ['rest', 'mcp_tool'], concurrency: true }),
		reject: resource('estimates.reject', 'POST', '/v1/structured-agent-estimates/{estimateId}/reject', { estimateId: z.string().min(1) }, { capability: 'estimates.decide', scopes: ['treeseed:execution'], surfaces: ['rest', 'mcp_tool'], concurrency: true }),
	},
	assignmentGraphs: {
		...
		approveContract: resource('assignment.deliverable.contracts.approve', 'POST', '/v1/deliverable-contracts/{contractId}/approve', { contractId: z.string().min(1) }, { capability: 'assignments.decide', scopes: ['treeseed:execution'], surfaces: ['rest', 'mcp_tool'], concurrency: true }),
		rejectContract: resource('assignment.deliverable.contracts.reject', 'POST', '/v1/deliverable-contracts/{contractId}/reject', { contractId: z.string().min(1) }, { capability: 'assignments.decide', scopes: ['treeseed:execution'], surfaces: ['rest', 'mcp_tool'], concurrency: true }),
	},
	research: {
