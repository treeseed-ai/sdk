...
export const CONTROL_PLANE_OPERATIONS = {
	...
	governance: {
		proposals: resource('governance.proposals.list', 'GET', '/v1/projects/{projectId}/proposals', { projectId: z.string().min(1) }, { capability: 'governance.read', surfaces: ['rest', 'cli', 'mcp_tool', 'mcp_resource'], pagination: 'cursor' }),
		createProposal: resource('governance.proposals.create', 'POST', '/v1/projects/{projectId}/proposals', { projectId: z.string().min(1) }, { capability: 'governance.write', scopes: ['treeseed:governance:write'], surfaces: ['rest', 'cli', 'mcp_tool'] }),
		proposal: resource('governance.proposals.show', 'GET', '/v1/projects/{projectId}/proposals/{proposalId}', { projectId: z.string().min(1), proposalId: z.string().min(1) }, { capability: 'governance.read', surfaces: ['rest', 'cli', 'mcp_resource'] }),
		updateProposal: resource('governance.proposals.update', 'PATCH', '/v1/projects/{projectId}/proposals/{proposalId}', { projectId: z.string().min(1), proposalId: z.string().min(1) }, { capability: 'governance.write', scopes: ['treeseed:governance:write'], surfaces: ['rest', 'cli'], concurrency: true }),
		resolveProposalFeedback: resource('governance.proposals.feedback.resolve', 'POST', '/v1/projects/{projectId}/proposals/{proposalId}/feedback/{feedbackId}/resolve', { projectId: z.string().min(1), proposalId: z.string().min(1), feedbackId: z.string().min(1) }, { capability: 'governance.write', scopes: ['treeseed:governance:write'], surfaces: ['rest', 'cli'], concurrency: true }),
		openProposal: resource('governance.proposals.open', 'POST', '/v1/projects/{projectId}/proposals/{proposalId}/open', { projectId: z.string().min(1), proposalId: z.string().min(1) }, { capability: 'governance.write', scopes: ['treeseed:governance:write'], surfaces: ['rest', 'cli'], concurrency: true }),
		startVoting: resource('governance.proposals.voting.start', 'POST', '/v1/projects/{projectId}/proposals/{proposalId}/start-voting', { projectId: z.string().min(1), proposalId: z.string().min(1) }, { capability: 'governance.write', scopes: ['treeseed:governance:write'], surfaces: ['rest', 'cli'], concurrency: true }),
		vote: resource('governance.proposals.vote', 'POST', '/v1/projects/{projectId}/proposals/{proposalId}/vote', { projectId: z.string().min(1), proposalId: z.string().min(1) }, { capability: 'governance.write', scopes: ['treeseed:governance:write'], surfaces: ['rest', 'cli'] }),
		evaluate: resource('governance.proposals.evaluate', 'POST', '/v1/projects/{projectId}/proposals/{proposalId}/evaluate', { projectId: z.string().min(1), proposalId: z.string().min(1) }, { capability: 'governance.decide', scopes: ['treeseed:governance:write'], surfaces: ['rest', 'cli'], concurrency: true }),
		...
		decisions: resource('governance.decisions.list', 'GET', '/v1/projects/{projectId}/decisions', { projectId: z.string().min(1) }, { capability: 'governance.read', surfaces: ['rest', 'cli', 'mcp_tool', 'mcp_resource'], pagination: 'cursor' }),
		decision: resource('governance.decisions.show', 'GET', '/v1/projects/{projectId}/decisions/{decisionId}', { projectId: z.string().min(1), decisionId: z.string().min(1) }, { capability: 'governance.read', surfaces: ['rest', 'cli', 'mcp_resource'] }),
	...
	execution: EXECUTION_OPERATIONS,
	research: {
	...
	agents: {
		...
		handler: resource('agents.handlers.show', 'GET', '/v1/projects/{projectId}/agent-handlers/{handlerId}', { projectId: z.string().min(1), handlerId: z.string().min(1) }, { capability: 'agents.read', surfaces: ['rest', 'cli', 'mcp_resource'] }),
		validateProfile: resource('agents.profiles.validate', 'GET', '/v1/projects/{projectId}/agents/{agentSlug}/validation', { projectId: z.string().min(1), agentSlug: z.string().min(1) }, { capability: 'agents.read', surfaces: ['rest', 'cli', 'mcp_tool'] }),
	...
	providers: {
		...
		offers: resource('providers.offers.show', 'GET', '/v1/teams/{teamId}/capacity-providers/{providerId}/offers', { teamId: z.string().min(1), providerId: z.string().min(1) }, { capability: 'providers.read', surfaces: ['rest', 'cli', 'mcp_resource'] }),
