...
export const AI_INSTANCE_OPERATIONS={
 storageShow:defineOperation(descriptor('storageShow','GET','/v1/teams/{teamId}/ai-instances/{instanceId}/storage'),{path:instance,query:empty,body:z.undefined(),output:record}),
 storagePut:defineOperation(descriptor('storagePut','PUT','/v1/teams/{teamId}/ai-instances/{instanceId}/storage'),{path:instance,query:empty,body:aiStorageBindingSchema,output:record}),
 storageRemove:defineOperation(descriptor('storageRemove','DELETE','/v1/teams/{teamId}/ai-instances/{instanceId}/storage'),{path:instance,query:empty,body:empty,output:record}),
