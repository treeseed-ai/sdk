...
const operationBindings: Record<string, Execution> = {
	...
	'send': operation('communications.send', [field('path', 'teamId', 'context', 'team', true), field('path', 'channel', 'argument', 'channel'), field('body', 'message', 'argument', 'message'), field('body', 'recipients', 'option', 'to'), field('body', 'proposalId', 'option', 'proposal'), field('body', 'timeoutSeconds', 'option', 'timeout', false, 'integer')]),
