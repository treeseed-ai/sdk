	...
	return {
		...
		note: {
			...
			fields: {
				...
				related_decisions: field('related_decisions', { aliases: ['relatedDecisions'], filterable: true, comparableAs: 'string_array', contentKeys: ['related_decisions', 'relatedDecisions'], writeContentKey: 'related_decisions' }),
			...
			filterableFields: ['title', 'about', 'related_objectives', 'related_questions', 'related_proposals', 'related_decisions', 'related_books', 'status', 'author', 'tags', 'date', 'updated_at'],
