...
export const TRESEED_OPERATION_SPECS: TreeseedOperationSpec[] = [
	command({
		...
		usage: 'treeseed setup [--environment <local|staging|prod>]... [--sync <none|github|cloudflare|railway|all>] [--json]',
		options: [
			...
			{ name: 'sync', flags: '--sync <mode>', description: 'Optionally sync GitHub, Cloudflare, or Railway settings.', kind: 'enum', values: ['none', 'github', 'cloudflare', 'railway', 'all'] },
	...
	command({
		...
		usage: 'treeseed prepare [--environment <local|staging|prod>]... [--sync <none|github|cloudflare|railway|all>] [--json]',
		options: [
	...
	command({
		...
		usage: 'treeseed publish --environment <local|staging|prod> [--dry-run] [--only <migrate|build|publish|api|agents>] [--json]\n  treeseed publish --target-branch <branch> [--dry-run] [--only <migrate|build|publish|api|agents>] [--json]',
		options: [
			...
			{ name: 'only', flags: '--only <step>', description: 'Limit execution to site migrate/build/publish or managed API/agent service deploys.', kind: 'enum', values: ['migrate', 'build', 'publish', 'api', 'agents'] },
