...
export function classifyRepoKind(packageJson: Record<string, unknown> | null, managedKind?: TreeseedManagedRepositoryKind): RepoKind {
...
export function verifyCommandFromString(repoDir: string, label: 'fast' | 'local' | 'release', command: string | null): TreeseedPackageCommand | null {
