...
import { resolveConfiguredControlPlaneBaseUrl,resolveConfiguredContentBucketName,resolveConfiguredContentPublicBaseUrl } from './assert-cloudflare-cache-purge-succeeded.ts';
...
export function buildPublicVars(deployConfig, options = {}) {
	...
	return {
		...
		PUBLIC_TURNSTILE_SITE_KEY: envOrNull('TREESEED_PUBLIC_TURNSTILE_SITE_KEY') ?? '',
