...
export function isManagedHostedProject(deployConfig: Pick<DeployConfig, 'hosting' | 'hub' | 'runtime'> | null | undefined) {
...
export function usesManagedHostOperationRequests(
	deployConfig: Pick<DeployConfig, 'hosting' | 'hub' | 'runtime'> | null | undefined,
	env: Record<string, string | undefined> = process.env,
) {
	return isManagedHostedProject(deployConfig) && !allowsManagedHostDirectCiSecrets(env);
}
