...
export function gitSync(args: string[], options: RunOptions): TreeseedGitRunnerResult {
...
export class TreeseedGitLockError extends Error {
...
export function staleTreeseedLock(lockPath: string) {
