...
import { TreeseedPackageAdapter, TreeseedPackageWorkflowSyncResult, TreeseedPackageWorkflowTemplateKind } from './treeseed-package-kind.ts';
import { discoverTreeseedPackageAdapters, findTreeseedPackageAdapter } from './plan-treeseed-package-development-image.ts';
import { workflowNameForTemplate } from './validate-treeseed-package-manifests.ts';
...
export function resolveWorkflowSetupCommand(adapter: TreeseedPackageAdapter) {
...
export function workflowTemplatesForAdapter(adapter: TreeseedPackageAdapter): TreeseedPackageWorkflowTemplateKind[] {
