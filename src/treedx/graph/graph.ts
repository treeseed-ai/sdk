...
import { resolveGraphRankingProvider } from '../../platform/support/plugins.ts';
	...
	constructor(
		...
		this.rankingProvider = options.rankingProvider
			?? (options.plugins?.length
				? resolveGraphRankingProvider(options.plugins, { projectRoot: repoRoot }) ?? DEFAULT_GRAPH_RANKING_PROVIDER
