...
import type { TreeDxFederatedClient } from './federated-client.ts';
import type { TreeDxGraphAdapter } from './graph-adapter.ts';
import type { TreeDxQueryAdapter } from './query-adapter.ts';
import type { TreeDxRegistryClient } from './registry-client.ts';
import type { TreeDxRepositoryAdapter } from './repository-adapter.ts';
import type { TreeDxWorkspaceAdapter } from './workspace-adapter.ts';
