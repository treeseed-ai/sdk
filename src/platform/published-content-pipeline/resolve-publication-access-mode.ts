...
import { PUBLICATION_ACCESS_MODES,type PublicationAccessMode } from '../../entrypoints/models/sdk-types.ts';
...
/** Normalize publication access metadata without coupling content to a sales system. */
export function resolvePublicationAccessMode(value: unknown): PublicationAccessMode {
	return typeof value === 'string' && (PUBLICATION_ACCESS_MODES as readonly string[]).includes(value)
		? value as PublicationAccessMode
		: 'free';
}
