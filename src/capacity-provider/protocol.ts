...
export const CAPACITY_PROVIDER_ENDPOINTS = {
	...
	assignmentExecutionStart: (assignmentId: string) => `/v1/provider/assignments/${encodeURIComponent(assignmentId)}/execution-start`,
	assignmentCloseoutStart: (assignmentId: string) => `/v1/provider/assignments/${encodeURIComponent(assignmentId)}/closeout-start`,
	assignmentCompletionPreflight: (assignmentId: string) => `/v1/provider/assignments/${encodeURIComponent(assignmentId)}/completion-preflight`,
	...
	assignmentSignals: (assignmentId: string) => `/v1/provider/assignments/${encodeURIComponent(assignmentId)}/signals`,
