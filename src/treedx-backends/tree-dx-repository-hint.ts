...
export interface TreeDxContentPathRule {
	paths: string[];
	repositoryHints?: TreeDxRepositoryHint[];
}
...
export interface AgentSdkTreeDxOptions {
	...
	ref?: string;
	workspaceId?: string;
	contentPathMap?: Record<string, string | TreeDxContentPathRule>;
	repositoryHints?: TreeDxRepositoryHint[];
...
export function repositoryMatchesHint(repository: Record<string, unknown>, hint: TreeDxRepositoryHint) {
...
export function makeDefaultPathRule(repoRoot: string, definition: SdkModelDefinition): TreeDxContentPathRule {
