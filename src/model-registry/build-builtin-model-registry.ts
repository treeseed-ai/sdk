...
import { buildKnowledgeModelRegistry } from './knowledge-models.ts';
import { buildAgentOperationalModelRegistry } from './agent-operational-models.ts';
	...
	return {
		...
		question: {
			...
			graph: graph({
				...
				groupField: 'projectId',
				enableSections: true,
				referenceFields: [{ field: 'subjectRef', edgeType: 'REFERENCES', targetModels: ['objective', 'question', 'proposal', 'decision', 'note', 'knowledge', 'book'] },
