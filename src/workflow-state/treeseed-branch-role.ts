...
export function emptyPersistentEnvironments(): TreeseedWorkflowState['persistentEnvironments'] {
	return {
...
export function emptyEnvironmentStatus(): TreeseedWorkflowState['environmentStatus'] {
	return {
...
export function emptyProviderStatus(): TreeseedWorkflowProviderStatus {
	const emptyScope = () => ({
