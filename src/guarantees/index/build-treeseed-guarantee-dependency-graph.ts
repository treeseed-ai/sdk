...
import { TreeseedGuaranteeDiagnostic, TreeseedGuaranteeFilter, TreeseedGuaranteeManifest, TreeseedGuaranteeRegistryReport, TreeseedGuaranteeVerifierContract, TreeseedLoadedGuarantee, TreeseedLoadedGuaranteeVerifierRegistry } from './treeseed-guarantee-schema-version.ts';
import { TreeseedGuaranteeDependencyGraph, TreeseedGuaranteeDependencyGraphMeta, TreeseedGuaranteeDependencyReason, allVerifierRefs, dependencyIdsForGuarantee, readSceneYaml, sceneManifestPathForGuarantee, sceneStateKeys, selectedByFilter, sortGuaranteeEntries, validateFilter } from './parse-verifier-registry.ts';
import { arrayOrEmpty, diagnostic } from './treeseed-guarantee-journey-audit-item.ts';

export function buildTreeseedGuaranteeDependencyGraph(input: { guarantees: TreeseedLoadedGuarantee[]; filter?: TreeseedGuaranteeFilter; includeDependencies?: boolean }): TreeseedGuaranteeDependencyGraph {
...
export function refs(contract: TreeseedGuaranteeVerifierContract | undefined) {
