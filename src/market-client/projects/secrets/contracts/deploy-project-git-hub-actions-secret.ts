...
export function deployProjectGitHubActionsSecretMethod(this: MarketClient, projectId: string, body: GitHubActionsEncryptedSecretDeployment & Record<string, unknown>) {
    return this.request<{
        ok: true;
        payload: unknown;
