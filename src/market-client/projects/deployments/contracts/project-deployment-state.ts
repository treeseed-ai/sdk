...
export function projectDeploymentStateMethod(this: MarketClient, projectId: string) {
    return this.request<MarketProjectDeploymentState>(`/v1/projects/${encodeURIComponent(projectId)}/deployment-state`, { requireAuth: true });
}
