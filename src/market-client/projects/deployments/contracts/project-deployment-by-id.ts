...
export function projectDeploymentByIdMethod(this: MarketClient, deploymentId: string) {
    return this.request<{
        ok: true;
        payload: ProjectDeployment;
    }>(`/v1/project-deployments/${encodeURIComponent(deploymentId)}`, { requireAuth: true });
}
