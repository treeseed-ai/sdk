...
export function projectDeploymentEventsMethod(this: MarketClient, projectId: string, deploymentId: string, options: {
    ...
    }>(`/v1/projects/${encodeURIComponent(projectId)}/deployments/${encodeURIComponent(deploymentId)}/events${query}`, { requireAuth: true });
}
