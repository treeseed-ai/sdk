...
export function createProjectWebDeploymentMethod(this: MarketClient, projectId: string, body: CreateProjectWebDeploymentRequest) {
    return this.request<CreateProjectWebDeploymentResponse>(`/v1/projects/${encodeURIComponent(projectId)}/deployments/web`, { method: 'POST', body, requireAuth: true });
}
