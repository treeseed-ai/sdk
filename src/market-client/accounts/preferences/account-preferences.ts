import type { AccountPreferences } from '../../../accounts/account-contracts.ts';
...
export function updateAccountPreferencesMethod(this: MarketClient, body: AccountPreferences) {
