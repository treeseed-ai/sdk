...
export function importProjectRepositoryMethod(this: MarketClient, teamId: string, plan: TreeseedRepositoryImportPlan | Record<string, unknown>) {
    return this.request<{
        ok: true;
        payload: Record<string, unknown>;
    }>(`/v1/teams/${encodeURIComponent(teamId)}/projects/import`, { method: 'POST', body: { plan }, requireAuth: true });
}
