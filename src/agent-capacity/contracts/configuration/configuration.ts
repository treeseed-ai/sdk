...
export const CAPACITY_CONFIGURATION_DESCRIPTORS: readonly CapacityConfigurationDescriptor[] = [
	{ id: 'provider-manifest', ownerPackage: '@treeseed/sdk', format: 'yaml', schemaId: 'treeseed.capacity-provider/v2', validator: 'validateCapacityProviderManifestV2', runtimeOwner: '@treeseed/agent' },
