import type { ProviderAssignmentCapabilityHandle, ProviderAssignmentCapabilityHandles, ProviderRepositoryAccessHandle, ProviderSecretUseHandle, ProviderTreeDxWorkspaceHandle, ProviderWorkflowOperationHandle } from '../contracts/assignment-records.ts';
