import { AGENT_ASSIGNMENT_WORKSPACE_ACCESS_MODES,type AgentAssignmentWorkspaceAccessMode,type AgentCapacityEnvelope,type DecisionExecutionInput,type ProviderAssignment,type ProviderAssignmentCapabilityHandles,type TreeDxProxyHandle } from '../../../contracts/capacity/assignments/assignment-records.ts';
import type { AgentKernelModeFallback,ProviderAssignmentSynthesisCandidate,TreeDxProxyAccessRequest,TreeDxProxyAccessResult } from '../../../contracts/runtime/runtime-observability.ts';
import { createAgentKernelModeFallback } from '../../support/mode-primitives.ts';
import { hasAcceptedCapacityPlanProvenance,isDecisionReadyForActing } from '../../support/planning.ts';
import { arrayValue,capabilityHandleArrays,isRecord,record,stringList,stringOrNull } from '../../support/primitives.ts';
