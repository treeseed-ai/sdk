...
import type { TreeseedSceneRendererAdapter } from './types.ts';
...
export function createRemotionTreeseedSceneRendererAdapter(): TreeseedSceneRendererAdapter {
	return {
		id: 'remotion',
		async render(input) {
...
export function resolveTreeseedSceneRemotionEntryPoint() {
