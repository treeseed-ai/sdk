import type { TreeseedSceneRemotionCompositionDefinition } from './types.ts';

const COMPOSITIONS: TreeseedSceneRemotionCompositionDefinition[] = [
...
export function listTreeseedSceneRemotionCompositions() {
	return [...COMPOSITIONS];
}
