...
import type { TreeseedSceneArtifactPathPlan, TreeseedSceneCheckpoint } from './types.ts';

export function createTreeseedSceneCheckpoint(input: {
...
export function writeTreeseedSceneCheckpoint(checkpoint: TreeseedSceneCheckpoint) {
