...
function renderPage(input: {
	...
	const findingsByCapture = new Map<string, TreeseedSceneVisualAuditFinding[]>();
...
export function writeTreeseedSceneVisualAuditContactSheets(input: {
	manifest: TreeseedSceneVisualAuditManifest;
	...
	const write = (name: string, title: string, captures: TreeseedSceneVisualAuditCapture[], findings = input.review.findings) => {
