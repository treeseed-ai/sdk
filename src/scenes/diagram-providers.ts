...
function propsFor(diagram: TreeseedSceneDiagram) {
...
function operationLifecycle(): TreeseedSceneDiagramDefinition {
	return {
...
function reconciliationLifecycle(): TreeseedSceneDiagramDefinition {
	return {
...
function devRuntimeTopology(): TreeseedSceneDiagramDefinition {
	return {
...
function sceneExecutionTimeline(): TreeseedSceneDiagramDefinition {
	return {
		...
		normalizeProps({ diagram, run }) {
			const props = propsFor(diagram);
			const report = run as TreeseedSceneRunReport | null | undefined;
			return {
...
export function createBuiltInTreeseedSceneDiagramProvider(): TreeseedSceneDiagramProvider {
	const diagrams = [
		operationLifecycle(),
