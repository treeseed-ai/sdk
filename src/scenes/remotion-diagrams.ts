...
import { interpolateSceneMotion, renderTreeseedVisualObject, visualStyle } from './remotion-visuals.ts';
import type { TreeseedSceneRenderDiagram } from './types.ts';
...
function diagramShell(diagram: TreeseedSceneRenderDiagram, frame: number, fps: number, children: React.ReactNode) {
	return React.createElement('div', {
		style: {
			width: '100%',
			height: '100%',
...
function OperationLifecycleDiagram(diagram: TreeseedSceneRenderDiagram, frame: number, fps: number) {
...
function ReconciliationLifecycleDiagram(diagram: TreeseedSceneRenderDiagram, frame: number, fps: number) {
	const props = diagram.props;
...
function DevRuntimeTopologyDiagram(diagram: TreeseedSceneRenderDiagram, frame: number, fps: number) {
	const props = diagram.props;
...
function SceneExecutionTimelineDiagram(diagram: TreeseedSceneRenderDiagram, frame: number, fps: number) {
	const props = diagram.props;
...
export function renderTreeseedSceneDiagram(input: {
