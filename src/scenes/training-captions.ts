...
export function buildTreeseedSceneCaptionCues(input: {
	...
	const cues: TreeseedSceneCaptionCue[] = [];
	...
	const byId = new Map<string, TreeseedSceneCaptionCue>();
...
export function formatTreeseedSceneCaptionsVtt(cues: TreeseedSceneCaptionCue[]) {
	const lines = ['WEBVTT', ''];
...
export function formatTreeseedSceneCaptionsSrt(cues: TreeseedSceneCaptionCue[]) {
	const lines: string[] = [];
