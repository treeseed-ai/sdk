...
export const SEVERITIES: TreeseedSceneVisualAuditFindingSeverity[] = ['blocking', 'high', 'medium', 'low', 'info'];

export const CATEGORIES: TreeseedSceneVisualAuditReviewCategory[] = ['functional', 'client-error', 'display', 'content', 'architecture'];

export const OWNERS: TreeseedSceneVisualAuditFindingOwner[] = ['@treeseed/ui', '@treeseed/admin', '@treeseed/core', '@treeseed/market', '@treeseed/api', '@treeseed/sdk', '@treeseed/cli', 'unknown'];
...
export function pathOwner(path: string): TreeseedSceneVisualAuditFindingOwner {
...
export function ownerFor(input: { capture: TreeseedSceneVisualAuditCapture; category: TreeseedSceneVisualAuditReviewCategory; code: string }): TreeseedSceneVisualAuditFindingOwner {
...
export function guidance(owner: TreeseedSceneVisualAuditFindingOwner, code: string) {
...
export function recommendedAction(owner: TreeseedSceneVisualAuditFindingOwner, code: string) {
...
export function finalPath(capture: TreeseedSceneVisualAuditCapture) {
...
export function captureFindings(capture: TreeseedSceneVisualAuditCapture, indexStart: number, route?: TreeseedSceneVisualAuditManifest['routes'][number]) {
...
export type EnrichedClientError = TreeseedSceneVisualAuditClientError & {
	path: string;
	pathRoot: string;
...
export function normalizedErrorMessage(error: TreeseedSceneVisualAuditClientError) {
...
export function errorIncidentCode(error: TreeseedSceneVisualAuditClientError) {
