...
import { planTreeseedReconciliation, reconcileTreeseedTarget, type TreeseedDesiredUnit, type TreeseedReconcileSelector, type TreeseedReconcileTarget } from "../../reconcile/index.ts";
...
export function appendReleaseImageRefGitHubVariableBindings(units: TreeseedDesiredUnit[], releaseImageRefs: Record<string, string>): TreeseedDesiredUnit[] {
