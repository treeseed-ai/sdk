...
class FetchTreeDxTransport implements Transport {
	constructor(private readonly config: TreeDxClientConfig) {}
...
async function requestData<T = unknown>(transport: Transport, request: TreeDxRequest): Promise<T> {
