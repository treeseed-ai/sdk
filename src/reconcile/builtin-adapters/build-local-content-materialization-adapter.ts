...
import { expectedLocalContentOrigin, localContentGitEnvironment, localContentObservedState, localContentSpecRecord, localContentSpecString, originMatches, runLocalContentClone } from './local-compose-build-policy.ts';
...
export function buildLocalContentMaterializationAdapter(): TreeseedReconcileAdapter {
	return {
		providerId: 'local',
...
export function buildLocalProcessAdapter(): TreeseedReconcileAdapter {
	return {
		providerId: 'local',
