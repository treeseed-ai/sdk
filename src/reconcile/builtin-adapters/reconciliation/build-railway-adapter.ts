...
export function buildCustomDomainAdapter(unitType: 'custom-domain:web' | 'custom-domain:api', providerId: 'cloudflare' | 'railway'): ReconcileAdapter {
	return {
		providerId,
		unitTypes: [unitType],
...
export function buildDnsRecordAdapter(): ReconcileAdapter {
	return {
