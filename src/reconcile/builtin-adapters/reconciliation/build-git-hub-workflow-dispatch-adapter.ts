...
export function buildPackageImageAdapter(): ReconcileAdapter {
	return {
...
export function buildDockerImageBuildAdapter(): ReconcileAdapter {
	return {
		providerId: 'docker',
...
export function runDockerImagePrepareCommand(input: ReconcileAdapterInput) {
