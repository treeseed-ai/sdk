import { loadDeployState } from "../../operations/services/deploy.ts";
import { configuredRailwayServices } from "../../operations/services/railway-deploy.ts";
import { ensureRailwayEnvironment, ensureRailwayProject, listRailwayEnvironmentServices, getRailwayServiceInstance, getRailwayProject, listRailwayProjects, listRailwayVariables, resolveRailwayWorkspaceContext } from "../../operations/services/railway-api.ts";
import type { RailwayServiceSummary } from "../../operations/services/railway-api.ts";
import type { TreeseedReconcileAdapterInput } from ".././contracts.ts";
import { buildRailwayEnv, providerCache, resolveReconcileEnvironmentValues } from './build-workflow-meta-adapter.ts';
...
export function recordRailwayProviderDrift(input: TreeseedReconcileAdapterInput, scope: string, drift: Record<string, unknown>) {
...
export function railwayProviderDrift(input: TreeseedReconcileAdapterInput, scope: string) {
...
export function configuredRailwayServicesForInput(input: TreeseedReconcileAdapterInput, scope: 'local' | 'staging' | 'prod') {
	return configuredRailwayServices(input.context.tenantRoot, scope, resolveReconcileEnvironmentValues(input, scope));
}

export function assertNoBlockedRailwayProviderDrift(input: TreeseedReconcileAdapterInput, scope: string) {
