...
export async function runCloudflareCleanup(cwd: string, environment: LiveReconcileEnvironment, prefix: string, mode: LiveReconcileMode, env: LiveEnv, fetchImpl: typeof fetch) {
...
export async function runCloudflareAcceptance(cwd: string, environment: LiveReconcileEnvironment, runId: string, prefix: string, env: LiveEnv, fetchImpl: typeof fetch, onProgress?: LiveProgress) {
	...
	const created: CanonicalGraphNode[] = [];
	const attempt = async (
		capability: string,
		type: string,
