...
export const PROVIDER_CAPABILITIES: Record<LiveReconcileProvider, string[]> = {
	...
	github: ['repository-adoption', 'bootstrap', 'branch', 'branch-rules', 'actions-settings', 'environment', 'secret', 'variable', 'workflow-presence', 'workflow-observation', 'central-token'],
